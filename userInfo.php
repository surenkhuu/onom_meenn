...
<div class="row">
 ...
 else echo $userimg;?>" id="imgAvator" width="200">
        </div>
...
function addSh_Table(tablename, ubchtunid)
{
	...
	$('#modalEditor').html('<div style="padding: 5px 25px 0 25px;"><h5>Түр хүлээнэ үү!</h5><div class="progress"><div class="indeterminate"></div></div><p>Мэдээллийг шалгаж байна</p><div class="modal-footer"><a href="#" class="waves-effect waves-green btn-flat modal-action modal-close">close</a></div></div>');
